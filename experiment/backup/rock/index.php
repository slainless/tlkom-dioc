<?php
    ...
    if (login_check($que_dash) == true) {
        if ($stmt = $que_rock->prepare("SELECT TANGGAL AS TANGGAL, COUNT(TROUBLE_NO) AS JUMLAH FROM " . $t_rock . " GROUP BY TANGGAL")) {
        ...
        if ($stmt = $que_rock->prepare("SELECT COUNT(TROUBLE_NO) AS JUMLAH FROM " . $t_nona_h . "")) {
...
<html>
    <head>
        <title>IOC | Database Nonatero</title>
        <meta charset="UTF-8">
        ...
        <div id="content">
                ...
                <div class="aside-main">
                    <div class="info">
                        <div class="info-container">
                            <div class="info-box"><span>4</span></div>
                            <div class="info-text">
                                <span>ADMIN</span>
                                <span>SERVER</span>
                            </div>
                    ...
                    <div class="list">
                        <ul>
                            ...
                            <li class="selected"><a href="#">ROCK</a></li>
                            <li class="dummy"></li>
            ...
            <div class="content">
                ...
                <div class="content-main">
                    <a class="btn-stretch-fullside" href="#">
                        <div class="half-left">
                            <div class="sub-left">
                                <span>Table</span>
                                <span>Current</span>
