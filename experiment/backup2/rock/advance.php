 <?php
    ...
    switch ($ut) {
        case '1':
            if(!include $f_rock){
                $c_text = "[ERROR&nbsp;&nbsp;] FILE " . $f_rock . " NOT FOUND";
            }
            break;
        case '2':
            if(!include $l_all){
...
?>
 <html>
    ...
    <body>
    	<div id="wrapper">
    		<div class="header">
    			<span>dioc / rock / advance.php</span>
    			<div class="wrapper">
    		...
    		<div class="body">
    			...
    			<div class="sidebar">
    				<ul>
    					...
    					<li class="selected"><a><i class="fa fa-home"></i></a></li>
