<?php
  ...
  $slv_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
...
$ttn_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
...
$plt_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
witel, KANDATEL_NEW3 kandatel, cmdf, rk,cprod,nd_telp,nd_int,paket_int,paket_iptv,GAUL_B0,GAUL_B1,GAUL_B2,GAUL30,GAUL30_BACK,LAPUL,trouble_no, trouble_opentime, headline, keluhan_desc, status, jam, hari,emosi_plg,decode(cprod,'1','TELEPON','11','INTERNET','8','IPTV') as PRODUK_GGN,TIPE_TIKET,SMS_OPEN,SMS_BACKEND,SMS_RESOLVED,EMAIL_OPEN,EMAIL_BACKEND,EMAIL_RESOLVED,TROUBLE_CLOSED_GROUP,
LOKER_DISPATCH,JML_LAPUL,CHANNEL
		 from (
select WITEL_NEW3 as WITEL,KANDATEL_NEW3,A.CMDF,A.RK,
...
$bsn_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
witel, KANDATEL_NEW3 kandatel, cmdf, rk,cprod,nd_telp,nd_int,paket_int,paket_iptv,GAUL_B0,GAUL_B1,GAUL_B2,GAUL30,GAUL30_BACK,LAPUL,trouble_no, trouble_opentime, headline, keluhan_desc, status, jam, hari,emosi_plg,decode(cprod,'1','TELEPON','11','INTERNET','8','IPTV') as PRODUK_GGN,TIPE_TIKET,SMS_OPEN,SMS_BACKEND,SMS_RESOLVED,EMAIL_OPEN,EMAIL_BACKEND,EMAIL_RESOLVED,TROUBLE_CLOSED_GROUP,
LOKER_DISPATCH,JML_LAPUL,CHANNEL
		 from (
select WITEL_NEW3 as WITEL,KANDATEL_NEW3,A.CMDF,A.RK,
...
$ent_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
witel, KANDATEL_NEW3 kandatel, cmdf, rk,cprod,nd_telp,nd_int,paket_int,paket_iptv,GAUL_B0,GAUL_B1,GAUL_B2,GAUL30,GAUL30_BACK,LAPUL,trouble_no, trouble_opentime, headline, keluhan_desc, status, jam, hari,emosi_plg,decode(cprod,'1','TELEPON','11','INTERNET','8','IPTV') as PRODUK_GGN,TIPE_TIKET,SMS_OPEN,SMS_BACKEND,SMS_RESOLVED,EMAIL_OPEN,EMAIL_BACKEND,EMAIL_RESOLVED,TROUBLE_CLOSED_GROUP,
LOKER_DISPATCH,JML_LAPUL,CHANNEL
		 from (
select WITEL_NEW3 as WITEL,KANDATEL_NEW3,A.CMDF,A.RK,
...
$hc_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
witel, KANDATEL_NEW3 kandatel, cmdf, rk,cprod,nd_telp,nd_int,paket_int,paket_iptv,GAUL_B0,GAUL_B1,GAUL_B2,GAUL30,GAUL30_BACK,LAPUL,trouble_no, trouble_opentime, headline, keluhan_desc, status, jam, hari,emosi_plg,decode(cprod,'1','TELEPON','11','INTERNET','8','IPTV') as PRODUK_GGN,TIPE_TIKET,SMS_OPEN,SMS_BACKEND,SMS_RESOLVED,EMAIL_OPEN,EMAIL_BACKEND,EMAIL_RESOLVED,TROUBLE_CLOSED_GROUP,
LOKER_DISPATCH,JML_LAPUL,CHANNEL
		 from (
select WITEL_NEW3 as WITEL,KANDATEL_NEW3,A.CMDF,A.RK,
...
$g3p_fq = "SELECT ROW_NUMBER() OVER (ORDER BY TROUBLE_OPENTIME ASC) NO,
regional,witel, KANDATEL_NEW3 kandatel, cmdf, rk,cprod,nd_telp,nd_int,paket_int,paket_iptv,GAUL_B0,GAUL_B1,GAUL_B2,GAUL30,GAUL30_BACK,LAPUL,trouble_no, trouble_opentime, headline, keluhan_desc, status, jam, hari,emosi_plg,decode(cprod,'1','TELEPON','11','INTERNET','8','IPTV') as PRODUK_GGN,TIPE_TIKET,SMS_OPEN,SMS_BACKEND,SMS_RESOLVED,EMAIL_OPEN,EMAIL_BACKEND,EMAIL_RESOLVED,TROUBLE_CLOSED_GROUP,
LOKER_DISPATCH,JML_LAPUL,CHANNEL
     from (
select regional_new2 as regional,WITEL_NEW3 as WITEL,KANDATEL_NEW3,A.CMDF,A.RK,
