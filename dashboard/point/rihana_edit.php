...
<html div class="uk-height-1-1">
    ...
    <div class="sd-fixed sd-fixed-top">
        <a href="rihana.php"><i class="uk-icon-medium uk-icon-th-large uk-icon-spin uk-animation-hover"></i></a>
    </div>
                    ...
                    <form class="uk-form sd-box" action="" method="POST" id="option-form" name="registration-form">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="uk-grid uk-text-center">
                                ...
                                <?php if($mode == 0){ echo "INSERT DATA RIHANA"; }
                                        else{ echo "EDIT DATA RIHANA"; }
                                ?>
                                </h3>
                            </div>
