<?php
    ...
    $page_title = "Point | Manual Update";
                                ...
                                <div>
                                    <div class="uk-width-1-1">
                                        <div class="uk-grid uk-grid-width-1-3 uk-grid-small">
                                            <div>
                                                <button class="uk-button uk-button-primary uk-width-1-1 uk-hidden-small ut-1"><span class="uk-icon-random uk-icon-justify"></span> UPDATE DATA</button>
                                            ...
                                            <div>
                                                <button class="uk-button uk-button-primary uk-width-1-1 uk-hidden-small ut-2"><span class="uk-icon-calculator uk-icon-justify"></span> RECALC DATA</button>
