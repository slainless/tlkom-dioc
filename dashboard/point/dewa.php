<?php
    ...
    FROM " . $t_nona_odw . "" . $condition . " LIMIT ?, ?")) {
    ...
    if ($stmt = $query->prepare("SELECT 
    COUNT(TROUBLE_NO) as number FROM " . $t_nona_odw . "" . $condition . "")) {
        ...
        <div class="uk-width-1-1 sd-content sd-table">
            <table class="uk-table">
                <thead class="uk-contrast">
                    <tr>
                        <td colspan="5"><a class="submit" href="#inputpop" data-uk-modal><i class="uk-icon-medium uk-icon-chrome uk-icon-spin"></i></a></td>
                ...
                ?>
                    ...
                    <tr <?php if($row["FLAG_COLOR"] != "#000000" && !empty($row["FLAG_COLOR"])) echo "style='background-color: ".$row["FLAG_COLOR"].";' class='uk-contrast'"; ?>>
                        ...
                        <td>
                            <span><?php echo $row["DEWA"]; ?></span>
                        </td>
                        <td>
                            <span><?php echo $row["KETERANGAN"]; ?></span>
                        </td>
                        <td>
                            <span><?php echo $row["PERBAIKAN"]; ?></span>
                        </td>
                        <td>
