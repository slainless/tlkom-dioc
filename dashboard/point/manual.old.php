<?php
    ...
    $page_title = "Point | Update Manual";
    ...
    $f_nona = "renew_data.php";
    $f_plg = "update_data.php";
            ...
            <div>
                <div class="uk-panel-space">
                    <ul class="uk-breadcrumb">
                        <li><a class="uk-text-uppercase" href="../point/">Nonatero</a></li>
                                        ...
                                        <li class="uk-width-1-1">
                                            <a class="uk-button uk-width-1-1 sd-button-large" id="fetch_btn">
                                                <div class="uk-panel">
                                                    ...
                                                    <div class="uk-text-right"><span>UPDATE</span><br><span>DATA POINT</span></div>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="uk-width-1-1">
                                            <a class="uk-button uk-width-1-1 sd-button-large" id="cmdf_btn">
                                                <div class="uk-panel">
                                                    <div class="sd-badge uk-panel-badge"><i class="uk-icon-calculator uk-icon-large"></i></div>
                                                    <div class="uk-text-right"><span>RECALC</span><br><span>DATA POINT</span></div>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="uk-width-1-1" style="visibility: hidden;">
                                            <a class="uk-button uk-width-1-1 sd-button-large">
                                                <div class="uk-panel">
